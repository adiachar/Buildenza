...
export default function ToolsWorkflows() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-24 text-center space-y-8">
      ...
      <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-tight">
        AI Tools & Workflows (Beginner to Advanced)
      </h1>
      <p className="text-xl md:text-2xl text-black/60 font-light max-w-2xl mx-auto">
        Learn how tools actually connect together to produce consistent, high-quality results.
      </p>
